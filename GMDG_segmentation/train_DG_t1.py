...
def main():
    ...
    if args.wandb_name:
        # if args.local_rank == 0:
         wandb.init(project='Res_DG', name=args.wandb_name, config=args)
    ...
    while i < args.max_iter:
        ...
        i = train(train_loader, net, Y_net, optim,  Y_optim,  epoch, writer, scheduler, Y_scheduler, args.max_iter,  d_mean_encoders, d_var_encoders, extra_val_loaders, criterion_val, d_var_optim, d_var_scheduler )
...
def train(train_loader, net, Y_net, optim, Y_optim, curr_epoch, writer, scheduler,Y_scheduler, max_iter,
          d_mean_encoders, d_var_encoders, extra_val_loaders, criterion_val, d_var_optim, d_var_scheduler):
    """
